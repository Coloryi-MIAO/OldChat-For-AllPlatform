...
class AppLocalizations {
  ...
  static final _english = <String, String>{
    ...
    '本地 CIP': 'Local CIP',
    'CIP 商店': 'CIP store',
    '加载 CIP 商店': 'Load CIP store',
    'CIP 商店加载失败': 'Failed to load the CIP store',
    'CIP 已下载并导入': 'CIP downloaded and imported',
    'CIP 下载失败': 'CIP download failed',
    'CIP 商店条目没有下载地址': 'The CIP store item has no download URL',
    'CIP 下载地址无效': 'The CIP download URL is invalid',
    'CIP 下载内容为空': 'The CIP download was empty',
    'CIP 文件不能超过 2 MiB': 'A CIP file cannot exceed 2 MiB',
    ...
    '选择消息': 'Select messages',
    '转发': 'Forward',
    '转发成功': 'Forwarded successfully',
    '转发失败：\$error': 'Forward failed: \$error',
    '目标会话 UID/群 ID': 'Target UID/group ID',
    '删除好友': 'Delete friend',
    '删除好友失败：\$error': 'Failed to delete friend: \$error',
    '确认删除该好友？': 'Delete this friend?',
    '好友已删除': 'Friend deleted',
    '新建群聊': 'New group chat',
    '群名称': 'Group name',
    '成员 UID（逗号分隔）': 'Member UIDs (comma separated)',
    '创建': 'Create',
    '群聊已创建': 'Group created',
    '创建群聊失败：\$error': 'Failed to create group: \$error',
    '群公告': 'Group announcement',
    '暂无群公告': 'No group announcement',
    '加载群公告失败：\$error': 'Failed to load announcement: \$error',
